...
1. *[[https://github.com/ArenT1981/ArenT-portfolio/tree/master/rsync-incremental-backup/rsync-inc-1.0.tar.gz][Download and extract the script]]* (right click, "Save link as...",
...
5. Set: 
6. =BACKUP_DIR= (line 4) 
7. =BACKUP_LOCATION= (line 6)
8. =REMOTE_LOCATION= (line 8) 
